      ...
      <Routes>
        ...
        <Route path={routes.SIGNUP} element={<SignUp />} />
         ...
         <Route
                ...
                element={
                  <CommentFeedback id="comments" type="submit" container="container" title1="Comment Feedback" title2="(Optional)" design={true} desription1="Found an error? Have a suggestion?" description2="Fill out the form below" placeholder="Enter Your Feedback here" heightt="30vh" buttons={[
                    { button: "SKIP" },
              ...
              {/* Servey */}
              <Route path={routes.SURVEY} element={
                <CommentFeedback
                  id="survey"
                  container="container"
                  title1="Paper Survey !:)"
                  ...
                  questions={[
                    ...
                    {
                      id: "q2",
                      question: "2) If you have experienced technical issues, please describe here?",
                      type: "textarea",
                    ...
                    {
                      id: "q4",
                      question: "4) Would you recmmend this as a useful learning tool for other trainers?",
                      options: ["Yes", "No"]
                    },
                    {
                      id: "q5",
                  ...
                  buttons={[
                    { button: "SUBMIT",  margin: "0 0 0 -70px" }
                  ]} />
              } />
